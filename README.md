...
[![Mode](https://img.shields.io/badge/Mode-Penetration_Testing-red.svg)]()
[![Platform](https://img.shields.io/badge/Platform-macOS%20%7C%20Linux-lightgrey.svg)]()

_Automate the boring. Hunt the critical._
...
- `nuclei`
- `waybackurls`
- `sqlmap` _(Managed automatically in the Python `venv`)_
- `arjun` _(Managed automatically in the Python `venv`)_
